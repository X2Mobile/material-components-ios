...
static const CGFloat MDCTextInputClearButtonImageSquareWidthHeight = 17;
...
- (void)setupUnderlineLabels {
    ...
    [NSLayoutConstraint constraintWithItem:_trailingUnderlineLabel
                                ...
                                multiplier:1
                                  constant:-10];
    trailingTop.priority = UILayoutPriorityDefaultHigh;
    
    [NSLayoutConstraint activateConstraints:@[ leadingTop, trailingTop ]];
